...
type NetLossOp struct {
	param NetLossParam
}

type NetLossParam struct {
	DesIP          string
	ExcludePort    string
	ExcludeIP      string
	Interface      string
...
func (op NetLossOp) Name() string {
	return "netloss"
}

func (op NetLossOp) Desc() string {
	return "test resilience for network loss"
}

func (op NetLossOp) Validate(params map[string]interface{}) error {
	var param NetLossParam
...
func (op NetLossOp) Params() ParamSpec {
...
func (op NetLossOp) Init() error {
	return nil
}

func (op NetLossOp) Run(params map[string]interface{}) (string, string, error) {
	// get parameters
	var param NetLossParam
	err := utils.DecodeParams(params, &param)
	if err != nil {
	...
	args := []string{"create", "network", "loss"}
	if param.DesIP != "" {
...
func (op NetLossOp) Destroy(id string) (string, error) {
